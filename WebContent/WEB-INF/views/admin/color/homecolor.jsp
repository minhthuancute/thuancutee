...
<body>
	...
	<div class="container">
			<a
				href="${pageContext.request.contextPath}/admin/color/addcolor.htm"
				class="btn btn-primary">Thêm màu</a>
		</div>
	<form method="post">
		...
		<table class="table table-bordered mt-3 container">
			...
			<c:forEach items="${mau}" var="o">
				<tr>
					...
					<td>${o.soLuong}</td>
					<td><a
						href="${pageContext.request.contextPath}/admin/color/editcolor/${o.idMau}.htm">
							<i class="fas fa-edit"></i>
					</a></td>
					<td><a onclick="return confirm('Bạn có chắc chắn muốn xóa size ${o.mau} này không?')" href="${pageContext.request.contextPath}/admin/color/deletecolor/${o.idMau}.htm">

...
<body>
	...
	<div class="modal-register changechange adminchange">
		<div class="formwrapper flex changeinfo">
			<form:form modelAttribute="sizeSP">
				<h2>SỬA SIZE</h2>
				<div class="password">
					<form:select path = "idSP" items="${idSP}" class="custom-select" disabled="disabled"/>
				</div>
				<div class="password">
					<form:select path = "size" items="${size}" class="custom-select" disabled="disabled"/>
